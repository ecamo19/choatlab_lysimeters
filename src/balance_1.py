...
def balance_1_main():
	...
	Log.enable(
		LogLevel.PHIDGET_LOG_INFO, f'../{serial_number}_data/{serial_number}_logs/phidgetlog_1.log'
	)
	...
	try:
		input('Clear any weight over the scale connected to the channel 1 and then press Enter\n')
